---
layout: post
title:  "Install cert manager at Kubernetes/MicroK8s"
date:   2024-02-08 7:03:52 +0100
categories: kubernetes certificates letsencrypt
---
<a href="https://cert-manager.io/docs/installation/" target="_new">https://cert-manager.io/docs/installation/</a>
...
{% highlight bash %}
chris@kube-2:~$ microk8s enable cert-manager
